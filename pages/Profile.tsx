        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-8 text-center sticky top-24">
            <div className="relative inline-block mb-6">
              <img src={(isEditing ? formData.profile_pic : user.profile_pic) || null} className="w-32 h-32 rounded-full border-4 border-green-50 object-cover bg-gray-50 shadow-md mx-auto" alt="Profile" referrerPolicy="no-referrer" />
